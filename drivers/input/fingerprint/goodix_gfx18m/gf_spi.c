...
#define GF_TTW_HOLD_TIME 2000 //Alan, add wakelock

//FihtdcCode@AlanHZ, Add for key define by customer
struct gf_key_map key_map[] =
{
//        name           Goodix define    Customer define1     Customer define2
      {  "POWER",         KEY_POWER,      KEY_WAKEUP,         KEY_WAKEUP},
      {  "WAKEUP",        KEY_WAKEUP,     KEY_WAKEUP,        KEY_WAKEUP},
      {  "HOME" ,         KEY_HOMEPAGE,   KEY_HOMEPAGE,       KEY_HOMEPAGE},
      {  "MENU" ,         KEY_MENU,       KEY_MENU,           KEY_MENU},
      {  "BACK" ,         KEY_BACK,       KEY_BACK,           KEY_APPSELECT},
      {  "UP"   ,         KEY_UP,         KEY_UP,             KEY_UP},
      {  "DOWN" ,         KEY_DOWN,       KEY_DOWN,           KEY_DOWN},
      {  "FORCE",         KEY_F9,         KEY_F9,             KEY_F9},
      {  "CLICK",         KEY_F19,        KEY_F19,            KEY_F19},
      {  "SINGLE CLICK",  KEY_F1,         KEY_F1,             KEY_F1},
      {  "DOUBLE CLICK",  KEY_F2,         KEY_F2,             KEY_F2},
      {  "LONGPRESS",     KEY_F3,         KEY_F3,             KEY_F3},
      {  "APP_SWITCH",    KEY_APPSELECT,  KEY_APPSELECT,      KEY_BACK},
};
