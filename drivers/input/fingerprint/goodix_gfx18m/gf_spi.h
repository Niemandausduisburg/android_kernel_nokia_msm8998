...
struct gf_key_map
{
    char *name;
    unsigned short val;
    unsigned short key_customer1;//rerfer from FihtdcCode@AlanHZ, Add for key define by customer
    unsigned short key_customer2;//rerfer from FihtdcCode@AlanHZ, Add for key define by customer
};
...
extern struct class *keydisabler_class;
extern struct class_attribute class_attr_key_disable;
